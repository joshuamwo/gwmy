  ...
  return (
    <div className="flex w-full flex-col transition-all duration-500">
      {tracks.map((track, index) => (
        <Link href={`/admin/my-music/track/${track.id}`} key={index}>
          <div className="hover:bg-light-00 flex w-full items-center gap-4 px-3 pb-2.5 pt-3 dark:hover:bg-dark-500">
