      ...
      <Combobox value={selectedOption} onChange={setSelectedOption}>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            afterLeave={() => setQuery("")}
          >
            <Combobox.Options className="absolute z-10 mt-1 max-h-32 w-full overflow-auto rounded-md bg-light dark:bg-dark-400 py-1 text-xs shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
