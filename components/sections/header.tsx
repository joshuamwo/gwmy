...
export default function Header({
  ...
  return (
    <div className="app-header fixed left-0 top-0 z-30 flex h-16  w-full items-center justify-between bg-light-400 px-4 py-1  dark:bg-dark-300 sm:h-[70px] sm:px-6">
